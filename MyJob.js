...
<PowerTranslator style={{alignSelf :'center',marginTop:-2,fontSize : 11,color :'#484849',fontFamily :'Poppins-Medium'}} text={'Job Id : 12345'} />
...
<PowerTranslator style={{alignSelf :'flex-start',fontSize : 11,color :'#181818',fontFamily :'Poppins-Medium'}} text={'2 Hours'} />
   ...
   <PowerTranslator style={{alignSelf :'flex-start',fontSize : 11,color :'#181818',fontFamily :'Poppins-Medium'}} text={'3-6 Year'} />
            ...
            <Button
           containerStyle={{width:window.width - 20,marginLeft : -72,marginTop : 8,padding:11, height:45, overflow:'hidden', borderRadius:4, backgroundColor: '#261650'}}
...
<Image style={{marginLeft :10,marginTop :12,height :25,width :25,resizeMode:'contain'}}
               ...
               <PowerTranslator style={{marginLeft : 15,marginTop:12,fontSize : 16,color :'white',fontFamily :'Poppins-Medium'}} text={'My Jobs'} />
</View>
