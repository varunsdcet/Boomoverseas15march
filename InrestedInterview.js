...
export default class InrestedInterview extends Component {
...
<PowerTranslator style={{alignSelf :'center',fontSize : 11,color :'#181818',fontFamily :'Poppins-Medium'}} text={item.job_location} />
 ...
 <View style = {{marginLeft :-65}}>
  ...
  getMoviesFromApiAsync = () => {
       ...
       const url = GLOBAL.BASE_URL +'my_interested_interviews';
     alert(url)
      fetch(url, {
  method: 'POST',
  headers: {
...
<Image style={{marginLeft :10,marginTop :10,height :25,width :25,resizeMode:'contain'}}
               ...
               <PowerTranslator style={{marginLeft : 15,marginTop:12,fontSize : 16,color :'white',fontFamily :'Poppins-Medium'}} text={'Saved Interview'} />
</View>
