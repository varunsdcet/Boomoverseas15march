...
export default class ProviderJobs extends Component {
...
this.props.navigation.navigate('Healthcare')
 ...
 buttonClickListener=()=>{
   this.props.navigation.navigate('ProviderJobDetail')
 }
...
<PowerTranslator style={{alignSelf :'flex-start',fontSize : 11,color :'#181818',fontFamily :'Poppins-Medium'}} text={overtime} />
  ...
  getMoviesFromApiAsync = () => {
       ...
       const url = GLOBAL.BASE_URL + 'company_posted_job';
    // alert(url)
      fetch(url, {
  method: 'POST',
  headers: {
  ...
  body: JSON.stringify({
    ...
    .then((responseJson) => {
     alert(JSON.stringify(responseJson))
       ...
       this.setState({ moviesList: responseJson.jobs})
...
<Image style={{marginLeft :10,marginTop :12,height :25,width :25,resizeMode:'contain'}}
               ...
               <PowerTranslator style={{marginLeft : 15,marginTop:12,fontSize : 16,color :'white',fontFamily :'Poppins-Medium'}} text={'Posted Jobs'} />
